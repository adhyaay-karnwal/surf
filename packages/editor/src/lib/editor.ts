...
export type ExtensionOptions = {
  ...
  breezeletComponent?: ComponentType<SvelteComponent>
...
export const createEditorExtensions = (opts?: ExtensionOptions) => [
  ...
  ...conditionalArrayItem(
    !!opts?.breezeletComponent,
    Breezelet.configure({
      component: opts?.breezeletComponent
    })
  ),
  ...conditionalArrayItem(
