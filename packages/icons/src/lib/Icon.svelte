<script lang="ts">
  ...
  /**
   * The name of the icon to display. The `name` prop must be one of the keys from the `Icons` enum in the `@mist/icons` package.
   */
...
<!--
@component Icon - A component that displays an icon from the `@mist/icons` package.

To use the `Icon` component, import it from the `@mist/icons` package and pass the `name` prop to specify the icon to display:
