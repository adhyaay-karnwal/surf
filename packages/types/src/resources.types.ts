...
export enum ResourceTagsBuiltInKeys {
  ...
  MISTLET_PROTOCOL_VERSION = 'mistletProtocolVersion', // version of the mistlet protocol used to save the resource
...
export interface ResourceTagsBuiltIn {
  ...
  [ResourceTagsBuiltInKeys.MISTLET_PROTOCOL_VERSION]: string
