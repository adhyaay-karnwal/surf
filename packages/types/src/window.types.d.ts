import type { NavigationEntry, Rectangle, Result } from 'electron'
...
export declare enum WebContentsViewActionType {
  ACTIVATE = 'activate',
  HIDE = 'hide',
  DESTROY = 'destroy',
  RELOAD = 'reload',
...
export interface WebContentsViewActionPayloads {
  ...
  [WebContentsViewActionType.RELOAD]:
    | {
        ignoreCache?: boolean
      }
    | undefined
  ...
  [WebContentsViewActionType.LOAD_URL]: {
    url: string
  }
  [WebContentsViewActionType.INSERT_TEXT]: {
    text: string
  }
  ...
  [WebContentsViewActionType.OPEN_DEV_TOOLS]: {
    mode?: Electron.OpenDevToolsOptions['mode']
  }
  [WebContentsViewActionType.SEND]: {
    channel: string
    args?: any[]
  }
  [WebContentsViewActionType.FIND_IN_PAGE]: {
    text: string
  ...
  [WebContentsViewActionType.EXECUTE_JAVASCRIPT]: {
    code: string
    userGesture?: boolean
  }
  [WebContentsViewActionType.DOWNLOAD_URL]: {
    url: string
    options?: Electron.DownloadURLOptions
  }
...
export interface WebContentsViewActionOutputs {
  ...
  [WebContentsViewActionType.CAPTURE_PAGE]: string
...
export declare enum WebContentsViewManagerActionType {
  CREATE = 'create',
  HIDE_ALL = 'hide-all',
...
export interface WebContentsViewManagerActionPayloads {
  ...
  [WebContentsViewManagerActionType.SHOW_ACTIVE]?:
    | {
        id?: string
      }
    | undefined
...
export declare enum WebContentsViewEventType {
