...
export declare enum WebViewEventReceiveNames {
...
export declare enum WebViewEventSendNames {
  Wheel = 'wheel',
...
export declare enum WebViewGestureRequiredEventNames {
...
export type WebViewEventBookmark = {
  text?: string
  url: string
}
export type WebViewEventAnnotation = {
  id: string
  data: ResourceDataAnnotation
}
export type WebViewEventHighlightText = {
  texts: string[]
}
export type WebViewEventSeekToTimestamp = {
  timestamp: number
}
...
export type WebViewSendEvents = {
  ...
  [WebViewEventSendNames.PIPState]: {
    pip: boolean
  }
  [WebViewEventSendNames.FullscreenChange]: {
    fullscreen: boolean
  }
}
export declare enum WebviewAnnotationEventNames {
...
export declare const WEBVIEW_MOUSE_CLICK_WINDOW_EVENT = 'webview-mouse-click'
//# sourceMappingURL=ipc.webview.types.d.ts.map
