...
- **Renamable nodes** - Integration with existing `@breeze/services/Renamable.svelte`
...
The component is fully integrated into the `@breeze/ui` package and follows all established patterns:
- Svelte 5 runes syntax
- `@breeze/` import namespace
