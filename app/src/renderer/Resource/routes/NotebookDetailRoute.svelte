<script lang="ts">
  ...
  import { Button, PageMention, NotebookLoader, Renamable, contextMenu, openDialog } from '@mist/ui'
  import TeletypeEntry from '../../Core/components/Teletype/TeletypeEntry.svelte'
  import { ResourceLoader, NotebookCover } from '@mist/ui'
  import type { ChatPrompt, NotebookEntry, Option, ViewLocation } from '@mist/types'
  ...
  import { useNotebookManager, type Notebook } from '@mist/services/notebooks'
