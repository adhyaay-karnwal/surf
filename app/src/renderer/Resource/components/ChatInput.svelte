...
<script lang="ts">
  ...
  import { conditionalArrayItem, useLogScope } from '@mist/utils'
  import { createEventDispatcher, tick } from 'svelte'
  import { elementFromString, type Editor, type MentionItem } from '@mist/editor'
  import type { ChatPrompt } from '@mist/services/ai'
  ...
  import { AddToContextMenu, Dropdown, ModelPicker } from '@mist/ui'
  import type { AIChatStatusMessage, AITool } from '@mist/types'
