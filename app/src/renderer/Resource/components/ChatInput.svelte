...
<script lang="ts">
  ...
  import { conditionalArrayItem, useLogScope } from '@breeze/utils'
  import { createEventDispatcher, tick } from 'svelte'
  import { elementFromString, type Editor, type MentionItem } from '@breeze/editor'
  import type { ChatPrompt } from '@breeze/services/ai'
  import { useConfig } from '@breeze/services'
  import { startingClass } from '@breeze/utils/dom'
  import type { MentionItemsFetcher } from '@breeze/editor/src/lib/extensions/Mention/suggestion'
  import { AddToContextMenu, Dropdown, ModelPicker } from '@breeze/ui'
  import type { AIChatStatusMessage, AITool } from '@breeze/types'
